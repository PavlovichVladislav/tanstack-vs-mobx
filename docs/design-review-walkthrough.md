...
- “Мы хотим выбрать универсальный стандарт для всех экранов или стандарт по умолчанию для server-state-heavy admin screens?”
...
- в `TanStack` orchestration частично переносится в query/mutation hooks и cache
...
- screen-level orchestration происходит через `useEffect`
...
- lifecycle приходится проектировать вручную
- чем больше экранов и shared data, тем больше риск расхождения patterns
